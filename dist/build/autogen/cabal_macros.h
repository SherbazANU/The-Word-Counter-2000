...
/* package TWC2K-0.1.0.0 */
#define VERSION_TWC2K "0.1.0.0"
#define MIN_VERSION_TWC2K(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "TWC2K-0.1.0.0"

#define CURRENT_PACKAGE_KEY "TWC2K-0.1.0.0"
